                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg">
                            <div class="form-group">
                                ...
                                {{ Form::select('city_id' , Illuminate\Support\Arr::pluck(city_list($item->state_id),'name','id') , null, array('class' => 'form-control select2')) }}
                            </div>
                        </div>
                        @if ($item->referrer_id)
                            <div class="col-md-6 col-lg">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('referrer_id',('gtedX'.$item->referrer_id), array('class' => 'form-control text-left', 'readonly')) }}
                                    <div id="showNameDetail">{{$item->referrer?$item->referrer->name:'___'}}</div>
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {{ Form::number('factor_count',null, array('class' => 'form-control text-left', 'required', 'min'=>1)) }}
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group">
