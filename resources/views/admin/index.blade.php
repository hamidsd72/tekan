...
{{--                            <h3 class="card-title">--}}
{{--                                <i class="fa fa-map-marker mr-1">200</i>--}}
{{--                                بازدید‌ها--}}
{{--                            </h3>--}}
{{--                            <!-- card tools -->--}}
{{--                            <div class="card-tools">--}}
...
{{--                                    <div id="sparkline-1">299</div>--}}
{{--                                    <div class="text-white">بازدید‌ها</div>--}}
{{--                                </div>--}}
{{--                                <!-- ./col -->--}}
{{--                                <div class="col-4 text-center">--}}
{{--                                    <div id="sparkline-2">299</div>--}}
{{--                                    <div class="text-white">آنلاین</div>--}}
{{--                                </div>--}}
{{--                                <!-- ./col -->--}}
{{--                                <div class="col-4 text-center">--}}
{{--                                    <div id="sparkline-3">800</div>--}}
        ...
        @section('js')
            ...
            <script>
                ...
                const data = {
                    labels: labels,
                    datasets: [{
                        label: 'لیست زیرمجموعه ها ',
                        backgroundColor: 'rgb(255, 99, 132)',
                        borderColor: 'rgb(255, 99, 132)',
                        data: [0, 10, 5, 2, 20, 30, 45,41,23,323,23,99],
                    }]
                };
